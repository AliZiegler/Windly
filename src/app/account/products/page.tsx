        ...
        return (
            <tr key={product.id} className="odd:bg-[#1c2129] even:bg-[#222831] hover:bg-[#2a3038] transition-colors duration-200">
                ...
                <td className="p-3 text-sm text-gray-300">
                    <div>
                        <b className="font-medium hover:text-[#00CAFF] duration-200">{product.category}</b>
                    </div>
                    <div>
                        <b className="text-xs text-gray-400 hover:text-[#00CAFF] duration-200">{product.brand}</b>
                    </div>
                </td>
                <td className="p-3 text-sm text-gray-300">
